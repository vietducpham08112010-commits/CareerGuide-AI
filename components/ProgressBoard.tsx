...
Hãy đưa ra nhận xét ngắn gọn 3-4 câu đánh giá tính thực thi, đà tăng trưởng và 2 hành động ưu tiên cho tuần tiếp theo. Nêu rõ ràng, truyền cảm hứng.`;
  ...
  const captureBoardCanvas = async (element: HTMLElement): Promise<string> => {
    return await captureElementToCanvasDataUrl(element, theme === Theme.DARK ? '#111111' : '#ffffff');
  };
              ...
              >
                ...
                <p className="text-gray-500 dark:text-gray-400 max-w-lg mx-auto text-sm leading-relaxed">
                  {language === Language.EN 
                    ? "Chat with the AI Assistant to generate a step-by-step personalized career roadmap." 
                    : "Hãy trò chuyện với AI để thiết kế lộ trình học tập 3 tháng hoàn chỉnh."}
                </p>
